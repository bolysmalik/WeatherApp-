...
final class MainViewController: UIViewController {
    ...
    private lazy var windView = WeatherInfoView()
    
    private lazy var pressureView = WeatherInfoView()
    ...
    private func setupViews() {
        ...
        [cityNameLabel, cityTemperatureLabel, currentWeatherLabel, hightLowLabel, cityFeelsLikeTemperatureLabel, hourlyView, weeklyView, stackView].forEach {
    ...
    func setupConstraints() {
        ...
        stackView.snp.makeConstraints { make in
            make.top.equalTo(weeklyView.snp.bottom).offset(16)
            make.leading.trailing.equalToSuperview()
...
extension MainViewController: MainDisplayLogic {
    ...
    func displayHourlyForecast(forecast: [MainModel.HourlyModel],
        ...
        DispatchQueue.main.async {
            ...
            self.windView.setData(title: "Wind Speed(m/s)", subTitle: String(currentForecast.windSpd))
            self.pressureView.setData(title: "Pressure(mb)", subTitle: String(currentForecast.pres))
        }
